   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      Begin VB.Frame fraDatabase 
         ...
         Begin VB.CommandButton CmdReloadSpells 
            ...
            Width           =   1455
         End
         Begin VB.CommandButton cmdReloadRooms 
            Caption         =   "Reload Maps"
            Height          =   255
            Left            =   240
            TabIndex        =   9
...
Private Sub cmdReloadRooms_Click()
    Call LoadRooms
    Call TextAdd("All Rooms reloaded.")
End Sub
...
Private Sub txtChat_KeyPress(KeyAscii As Integer)
    If KeyAscii = vbKeyReturn Then
        If LenB(Trim$(txtChat.Text)) > 0 Then
            Call GlobalMsg(COLOR_WHITE & txtChat.Text)
...
Sub mnuAdminPlayer_click()
    ...
    If Not Name = "Not Playing" Then
        ...
        Call PlayerMsg(FindPlayer(Name), COLOR_PINK & "You have been granted administrator access.")
    End If
End Sub
...
Sub mnuRemoveAdmin_click()
    ...
    If Not Name = "Not Playing" Then
        ...
        Call SendPlayerData(FindPlayer(Name))
        Call PlayerMsg(FindPlayer(Name), COLOR_BRIGHTRED & "Your administrative rank has been removed.")
    End If
End Sub
